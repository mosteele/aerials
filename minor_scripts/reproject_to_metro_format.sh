...
misprojected_tiff='E:/compressed4band/3in/1s1w01d.tif'
corrected_tiff='E:/compressed4band/temp/1s1w01d.tif'

convertRasterToMetroFormat $misprojected_tiff $corrected_tiff;